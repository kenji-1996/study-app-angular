...
let UserSchema  = new Schema({
    ...
    permissions: { type: Number, default: 0 },//Above 3 is admin
    lastLogin: { type: Date, default: Date.now },
    dateCreated: { type: Date, default: Date.now },
    //groups: [{type: Schema.Types.ObjectId, ref: 'groups'}],
    //organizations: [{type: Schema.Types.ObjectId, ref: 'orgs'}],
    generatedAccount: { type: Boolean, default: false },//If account is generated by a org or group they have certain restrictions
});
